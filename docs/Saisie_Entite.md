...
- [les informations de base](#informations-de-base-informations-basiques)
- [les médias](#media)
...
[![Nom](./Images_Entite/Nom.png)](Introduction.md#texte-text)

#### Précisions sur l'entité
Indiquez ici les précisions que vous souhaitez apporter.
[![Precisions_Entite](./Images_Entite/Precisions_Entite.png)](Introduction.md#texte-text)
...
[![Identifiant_Personne](./Images_Entite/Identifiant_Personne.png)](Introduction.md#texte-text)

#### Accès 
Sélectionnez si vous souhaitez que l’entité soit accessible au public ou non.
[![Acces](./Images_Entite/Acces.png)](Introduction.md#1-liste-deroulante)

#### Statut 
Sélectionnez le statut de création de l'entité.
[![Statut](./Images_Entite/Statut.png)](Introduction.md#1-liste-deroulante)
...
[![Adresse](./Images_Entite/Adresse.png)](Introduction.md#texte-text)

#### Tél / Fax 
Saisissez le numéro de Téléphone de l'entité
[![Telephone](./Images_Entite/Telephone.png)](Introduction.md#texte-text)

#### Adresse Email 
Indiquez ici l'adresse e-mail de l'entité
[![Adresse_Email](./Images_Entite/Adresse_Email.png)](Introduction.md#texte-text)

#### Type d’adresse 
Choisissez le type d'adresse de l'entité 
[![Type_Adresse](./Images_Entite/Type_Adresse.png)](Introduction.md#1-liste-deroulante)
...
[![Culture_Populaire](./Images_Entite/Culture_Populaire.png)](Introduction.md#texte-text)

#### Groupe de gens 
Saisissez ici la communauté à laquelle l'entité est associé
[![Groupe_Gens](./Images_Entite/Groupe_Gens.png)](Introduction.md#texte-text)

#### Groupe linguistique
La langue parlée par l'entité 
[![Groupe_Linguistique](./Images_Entite/Groupe_Linguistique.png)](Introduction.md#1-liste-deroulante)

#### Note biographique sur les personnes 
Information concernant l'histoire de l'entité
[![Note_Biographique](./Images_Entite/Note_Biographique.png)](Introduction.md#texte-text)

#### Dates essentielles 
Indiquez ici la date de naissance et de mort de l'entité
[![Dates_Essentielles](./Images_Entite/Dates_Essentielles.png)](Introduction.md#date-daterange)

#### Genre 
Précisez ici le genre de l'entité
[![Genre](./Images_Entite/Genre.png)](Introduction.md#1-liste-deroulante)

#### Nationalité d'une personne 
Notez ici la nationalité de l'entité
[![Nationalite](./Images_Entite/Nationalite.png)](Introduction.md#texte-text)

#### Emploi d'une personne 
Saisissez l'emploi de l'entité
[![Emploi](./Images_Entite/Emploi.png)](Introduction.md#texte-text)

#### Salutation 
Terme utilisé pour désigner l'entité (Monsieur, Madame, Docteur, etc..)
[![Salutation](./Images_Entite/Salutation.png)](Introduction.md#texte-text)

#### Son style / école 
Ce champ est lié au thesaurus « style / école » fourni par le Service des Musées de France
[![Style](./Images_Entite/Style.png)](Introduction.md#1-liste-deroulante)
...
[![Liens_Externes](./Images_Entite/Liens_Externes.png)](Introduction.md#texte-text)
