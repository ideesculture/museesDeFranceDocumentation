...
- [Saisie Joconde]()
	...
	- [les informations complémentaires](#informations-complementaires)
...
L'écran "Saisie Joconde" reprend les écrans "Identification", "Description du bien", "Contexte historique", "Statut juridique" et "Informations complémentaires". Pour y accéder directement donnez un [Numéro d'inventaire](#numero-dinventaire) à l'objet, [enregistrez](Introduction.md#enregistrer-annuler-supprimer) puis cliquez sur **Saisie Joconde** à gauche.
...
[![Numero_Inventaire](./Images_Objets/Numero_Inventaire.png)](Introduction.md#texte-text)

#### Autre numéro 
Saisissez les autres numéros de référence de l’objet ; vous pouvez saisir plusieurs autres numéros.
[![Autre_Numero](./Images_Objets/Autre_Numero.png)](Introduction.md#texte-text)

#### Ancien numéro 
Saisissez ici les anciens numéros qu'a pu avoir l'objet.
[![Ancien_Numero](./Images_Objets/Ancien_Numero.png)](Introduction.md#texte-text)

#### Domaine
Trouver le domaine de l'objet grâce à un [champ auto-completif](Introduction.md#3-recherche-par-auto-completion)
...
[![Domaine](./Images_Objets/Domaine.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Denomination](./Images_Objets/Denomination.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Appellation](./Images_Objets/Appellation.png)](Introduction.md#texte-text)
...
[![Titre_oeuvre](./Images_Objets/Titre_oeuvre.png)](Introduction.md#texte-text)

#### Auteur, exécutant, collecteur
Saisissez ici le nom du producteur de l’objet. Ce champ est directement lié aux enregistrements « [entités](Saisie_Entite.md) » :
...
[![Auteur](./Images_Objets/Auteur.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Auteur_2](./Images_Objets/Auteur_2.png)](Introduction.md#1-liste-deroulante)
...
[![Ecole](./Images_Objets/Ecole.png)](Introduction.md#3-recherche-par-auto-completion)

#### Anciennes attributions
Correspond aux informations sur le(s) ancien(s) possesseur(s) de l'objet
[![Anciennes_Attributions](./Images_Objets/Anciennes_Attributions.png)](Introduction.md#texte-text)

#### Période de création/exécution
Recherchez la période de production de l'objet (si connu) 
[![Periode_Creation](./Images_Objets/Periode_Creation.png)](Introduction.md#3-recherche-par-auto-completion)

#### Millésime de création/exécution 
Date de production précise de l'objet (si connu). 
[![Millesime_Creation](./Images_Objets/Millesime_Creation.png)](Introduction.md#date-daterange)
...
[![Epoque_Style](./Images_Objets/Epoque_Style.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Materiaux_Techniques](./Images_Objets/Materiaux_Techniques.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Marques_Inscriptions](./Images_Objets/Marques_Inscriptions.png)](Introduction.md#4-navigation-hierarchique-horizontale)

#### Précisions sur les inscriptions
Champ textuel permettant d'ajouter librement des informations sur l'inscription
[![Precisions_Inscriptions](./Images_Objets/Precisions_Inscriptions.png)](Introduction.md#texte-text)

#### Onomastique
Ce champ sert à préciser les noms propres (de personnages, d'auteurs, de lieux,...) liés à l'objet
[![Onomastique](./Images_Objets/Onomastique.png)](Introduction.md#texte-text)

#### Description
Au sein de ce champ, saisissez une description détaillée de votre objet
[![Description](./Images_Objets/Description.png)](Introduction.md#texte-text)
...
[![Etat_Bien_Acquisition](./Images_Objets/Etat_Bien_Acquisition.png)](Introduction.md#texte-text)
...
[![Description](./Images_Objets/Constat_Etat.png)](Introduction.md#1-liste-deroulante)
...
[![Representation](./Images_Objets/Representation.png)](Introduction.md#3-recherche-par-auto-completion)

#### Précision sur la représentation
Ce champ sert à apporter des précisions sur la représentation
[![Precisions_Representations](./Images_Objets/Precisions_Representations.png)](Introduction.md#texte-text)
...
[![Date_Representation](./Images_Objets/Date_Representation.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Genese](./Images_Objets/Genese.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Objet_associe](./Images_Objets/Objet_associe.png)](Introduction.md#3-recherche-par-auto-completion)

#### Historique
Champ texte vous permettant de décrire le contexte historique de l’objet
[![Historique](./Images_Objets/Historique.png)](Introduction.md#texte-text)
...
[![Lieu_Creation](./Images_Objets/Lieu_Creation.png)](Introduction.md#4-navigation-hierarchique-horizontale)
...
[![Precisions_Lieu_Creation](./Images_Objets/Precisions_Lieu_Creation.png)](Introduction.md#texte-text)

#### Géographie historique
Champ vous permettant de préciser le nom des lieux au moment de la création de l'objet
[![Geographie_Historique](./Images_Objets/Geographie_Historique.png)](Introduction.md#texte-text)
...
[![Utilisation_Destination](./Images_Objets/Utilisation_Destination.png)](Introduction.md#3-recherche-par-auto-completion)

#### Précisions sur l'utilisation/destination
Précisions sur le(s) utilisation(s)/destination(s) de l'objet
[![Precision_Utilisation_Destination](./Images_Objets/Precision_Utilisation_Destination.png)](Introduction.md#texte-text)

#### Lieu(x) d'utilisation, destination
Recherchez le lieu d'utilisation ou de destination de l'objet. 
Si le lieu n'existe pas vous pouvez [le créer](Saisie_Lieux.md)
[![Lieu_Utilisation_Destination](./Images_Objets/Lieux_Utilisation_Destination.png)](Introduction.md#4-navigation-hierarchique-horizontale)
...
[![Periode_Utilisation_Destination](./Images_Objets/Periode_Utilisation_Destination.png)](Introduction.md#4-navigation-hierarchique-horizontale)

#### Millésime d'utilisation/destination
Période à laquelle l'objet est utilisé (Année précise)
[![Millesime_Utilisation_Destination](./Images_Objets/Millesime_Utilisation_Destination.png)](Introduction.md#date-daterange)
...
[![Lieu_Decouverte](./Images_Objets/Lieu_Decouverte.png)](Introduction.md#4-navigation-hierarchique-horizontale)
...
[![Type_Site_Decouverte](./Images_Objets/Type_Site_Decouverte.png)](Introduction.md#3-recherche-par-auto-completion)
...
[Lien vers le thesaurus sur OpenTheso](https://opentheso.huma-num.fr/opentheso/?idt=th292)
[![Methode_Decouverte](./Images_Objets/Methode_Decouverte.png)](Introduction.md#3-recherche-par-auto-completion)
...
le champ "[Type de date](Introduction.md#3-recherche-par-auto-completion)" sert à préciser si la date est une date de découverte ou de collecte
[![Date_Decouverte](./Images_Objets/Date_Decouverte.png)](Introduction.md#date-daterange)

#### Découvreur
Saisissez ici le nom du découvreur.
[![Decouvreur](./Images_Objets/Decouvreur.png)](Introduction.md#texte-text)

#### Précisions sur la découverte 
Précisions sur la découverte, la collecte ou la récolte de l'objet
[![Precisions_Decouvreur](./Images_Objets/Precisions_Decouverte.png)](Introduction.md#texte-text)

#### Numéro du site SDA
Précisez ici le numéro du site SDA duquel est issu l'objet
[![Numero_Site_SDA](./Images_Objets/Numero_Site_SDA.png)](Introduction.md#texte-text)
...
[![Date_Inscription_Registre](./Images_Objets/Date_Inscription_Registre.png)](Introduction.md#date-daterange)

#### Type de propriété
Indiquez le type de propriété de l’objet parmi les choix disponibles
[![Type_Propriete](./Images_Objets/Type_Propriete.png)](Introduction.md#1-liste-deroulante)
...
[![Mode_Acquisition](./Images_Objets/Mode_Acquisition.png)](Introduction.md#1-liste-deroulante)
...
[![Mention_Concours_Publics](./Images_Objets/Mention_Concours_Publics.png)](Introduction.md#1-liste-deroulante)

#### Etablissement affectataire
Ce champ est lié au fichier des [entités](Saisie_Entite.md), saisissez l’établissement affectataire de l'objet.
[![Etablissement_Affectataire](./Images_Objets/Etablissement_Affectataire.png)](Introduction.md#3-recherche-par-auto-completion)

#### Date et références de l’acte d’acquisition
Saisissez la [date](Introduction.md#date-daterange) et la référence de l’acte d’acquisition.
Vous pouvez donner des précisions sur la date si dans la [liste déroulante](Introduction.md#1-liste-deroulante) à droite de la date
[![Date_Reference_Acte_Acquisition](./Images_Objets/Date_Reference_Acte_Acquisition.png)](Introduction.md#texte-text)

#### Date d’affectation au musée
Saisissez la date à laquelle l'objet à été affecté au musée. Utlisez la [liste déroulante](Introduction.md#1-liste-deroulante) à gauche pour apporter des précisions sur la liste
[![Date_Affectation_Musee](./Images_Objets/Date_Affectation_Musee.png)](Introduction.md#3-recherche-par-auto-completion)
...
[![Avis_Instances_Scientifique](./Images_Objets/Avis_Instances_Scientifique.png)](Introduction.md#1-liste-deroulante)

#### Anciennes appartenances
Champ texte qui vous permet de détailler les anciennes appartenances de l’objet.
[![Anciennes_Appartenances](./Images_Objets/Anciennes_Appartenances.png)](Introduction.md#texte-text)

#### Anciens Dépots
Champ texte qui permet de noter dans quel(s) dépot(s) à déja été entreposé l'objet
[![Anciens_Depots](./Images_Objets/Anciens_Depots.png)](Introduction.md#texte-text)
...
[![Exposition](./Images_Objets/Exposition.png)](Introduction.md#3-recherche-par-auto-completion)

#### Bibliographie
Champ de texte enrichi dans lequel vous pouvez saisir une note du publication
[![Bibliographie](./Images_Objets/Bibliographie.png)](Introduction.md#texte-text)
...
[![Commentaires](./Images_Objets/Commentaires.png)](Introduction.md#texte-text)

#### Crédits photographiques
Champ texte enrichi dans lequel vous pouvez saisir les crédits de photographies utilisée(s)
[![Credits_Photographiques](./Images_Objets/Credits_Photographiques.png)](Introduction.md#texte-text)

#### Rédacteur
Rédacteur de la notice : **plus** relié au fichier des entités
[![Redacteur](./Images_Objets/Redacteur.png)](Introduction.md#texte-text)
...
[![Media](./Images_Objets/Representations_Media.png)](Introduction.md#texte-text)
...
[![Acces](./Images_Objets/Acces.png)](Introduction.md#1-liste-deroulante)

#### Conditions d'accès
Les conditions d'accès physique du public à l'objet
[![Condition_Acces](./Images_Objets/Condition_Acces.png)](Introduction.md#texte-text)
